...
os.system('python main.py 7 32768 4 50 100')
os.system('python main.py 8 32768 4 50 100')
os.system('python main.py 9 32768 4 50 100')
...
os.system('python main.py 7 32768 8 50 100')
os.system('python main.py 8 32768 8 50 100')
os.system('python main.py 9 32768 8 50 100')